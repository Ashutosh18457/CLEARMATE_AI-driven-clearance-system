          ...
          <div className="bg-white rounded-xl border border-surface-200 shadow-xl max-w-lg w-full overflow-hidden space-y-0">
            ...
            <div className="p-4 border-t border-surface-200 bg-surface-50 flex items-center justify-end gap-3">
              <button
                type="button"
                onClick={() => setModalOpen(false)}
                className="px-4 py-2 text-xs font-medium text-surface-700 bg-white border border-surface-300 rounded-lg hover:bg-surface-100 transition"
              >
                Cancel
              </button>
              <button
                ...
                disabled={saving}
                className="px-4 py-2 text-xs font-semibold text-white bg-brand-600 rounded-lg hover:bg-brand-700 transition disabled:opacity-50 flex items-center gap-1.5 shadow-sm"
              >
                {saving ? (
                  <>

      ...
      students.map(async (student) => {
        ...
        return {
          student: {
            ...
            section: student.section,
            currentSemester: student.currentSemester,
            program: student.program || student.programId?.name || student.programId?.code || '—',
            programCode: student.program || student.programId?.code || '—',
            batch: student.batchId?.name || '—',
          },
  ...
  async getHallTicketRoster({ semesterId, programId, status = 'all', search = '' }) {
    ...
    let rows = students.map((st) => {
      ...
      return {
        ...
        program: st.program || st.programId?.name || st.programId?.code || '—',
        programCode: st.program || st.programId?.code || '—',

...
const sendPasswordResetEmail = async ({ email, resetUrl, name }) => {
  ...
  const mailOptions = {
    from: `"${process.env.EMAIL_FROM_NAME || 'ClearMate Support'}" <${process.env.EMAIL_FROM || process.env.EMAIL_USER || 'no-reply@sbjit.edu.in'}>`,
    to: email,
    ...
    html: `
      ...
      <body>
        <div class="container">
          ...
          <div class="footer">
            &copy; ${new Date().getFullYear()} ClearMate AI-Driven Clearance System. All rights reserved.
          </div>
        </div>
      </body>
      </html>
